...
export default function Chamados() {
  ...
  const columns = [
    ...
    { 
      ...
      flex: 1, 
      minWidth: 120,
      renderCell: (params) => params?.value ? formatCriticidade(params.value) : '', 
      filterable: true 
    },
    { 
      field: 'impacto', 
    ...
    { 
      ...
      renderCell: (params) => {
        ...
        const formattedTime = date.toLocaleTimeString('pt-BR', { timeZone: 'America/Sao_Paulo' });
  ...
  return (
    <Container sx={{ mt: 5 }}>
      <Typography variant="h4" gutterBottom>Listagem de Chamados</Typography>
